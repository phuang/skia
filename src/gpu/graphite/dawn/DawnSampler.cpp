...
static inline wgpu::FilterMode filter_mode_to_dawn_filter_mode(SkFilterMode mode) {
    switch (mode) {
...
static inline wgpu::FilterMode mipmap_mode_to_dawn_filter_mode(SkMipmapMode mode) {
    switch (mode) {
...
sk_sp<DawnSampler> DawnSampler::Make(const DawnSharedContext* sharedContext,
    ...
    std::string label;
    label.append("X").append(tileModeLabels[(int)xTileMode]);
    label.append("Y").append(tileModeLabels[(int)yTileMode]);
    label.append(minMagFilterLabels[(int)samplingOptions.filter]);
    label.append(mipFilterLabels[(int)samplingOptions.mipmap]);
